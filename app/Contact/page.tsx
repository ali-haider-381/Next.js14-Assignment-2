function contect(){
    ...
    <><section className="Sub-header">
            ...
            <h1>Contact Us</h1>
        </section><section className="loacation">
                <iframe
            ...
            </section><section className="contact-us">
                <div className="row">
            ...
            </section><section className="footer">
                <hr />
                <h4>About Us</h4>
                ...
                <p>Made with <i className="fas fa-heart"></i> by <a href="#">ALI Haider Developer</a></p>
